...
import 'package:desapetani/Services/apiStatic.dart';
import 'package:desapetani/UI/detailPetaniPage.dart';
import 'package:desapetani/UI/homePage.dart';
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(new MaterialPageRoute(
                            builder: (BuildContext contect) => DetailPetaniPage(
